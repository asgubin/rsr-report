...
@XmlRootElement(name = "tableRow_7_2_1")
@XmlAccessorType(XmlAccessType.FIELD)
public class TableRow_7_2_1 extends TableRow {

    protected TableRow_7_2_1() {
    }

    public TableRow_7_2_1(Event event, List<Param> paramList) {
        super(event, paramList);
    }

    public TableRow_7_2_1(String id, String text,
